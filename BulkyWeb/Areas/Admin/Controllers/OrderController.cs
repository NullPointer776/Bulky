    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult CancelOrder()
        {
            ...
            if (orderHeaderFromDb.PaymentStatus == SD.PaymentStatusApproved)
            {
                ...
                {
                    Amount = Convert.ToInt32(orderHeaderFromDb.OrderTotal * 100),
        ...
        public IActionResult Details_PAY_NOW()
        {
            ...
            OrderVM.OrderDetail = _unitOfWork.OrderDetail.GetAll(u => u.OrderHeaderId == OrderVM.OrderHeader.Id, includeProperties: "Product").ToList();
        ...
        public IActionResult GetAll(string status)
        {
            ...
            else
            {
                ...
                objOrderHeaders = _unitOfWork.OrderHeader
                    .GetAll(u => u.ApplicationUserId == claim.Value, includeProperties: "ApplicationUser").ToList();
            }
